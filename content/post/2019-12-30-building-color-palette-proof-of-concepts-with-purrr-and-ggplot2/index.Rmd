...
the square root of an input). For `build_vir_poc`, we use a varient of `walk()`: 
`walk2()`. `walk2` lets you iterate over a pair of vectors for when you have two 
parameters that you wnat to change.
...
is a dealbreaker. I'd want to cut it even before presenting my findings. 
